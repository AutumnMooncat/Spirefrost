...
{
    internal class VigorIcon : SpirefrostBuilder
    {
        internal static string ID => "STS Vigor Icon";

        internal static string FullID => Extensions.PrefixGUID(ID, MainModFile.instance);

        internal static string SpriteID => "spirefrost.stsvigor";
        ...
        internal static object GetBuilder()
        {
            return new StatusIconBuilder(MainModFile.instance)
                .Create(ID, SpriteID, MainModFile.instance.ImagePath("Icons/VigorIcon.png"))
                ...
                .FreeModify(icon =>
                {
                    ...
                    GameObject vfxApply = new SpirefrostVFXBuilder(MainModFile.instance, "Icons/VigorIcon.png")
