...
{
    internal class PlasmaIcon : SpirefrostBuilder
    {
        internal static string ID => "STS Plasma Icon";

        internal static string FullID => Extensions.PrefixGUID(ID, MainModFile.instance);

        internal static string SpriteID => "spirefrost.stsplasma";
        ...
        internal static object GetBuilder()
        {
            return new StatusIconBuilder(MainModFile.instance)
                .CreateCustom(ID, SpriteID, MainModFile.instance.ImagePath("Icons/PlasmaIcon.png"))
                ...
                .WithTextboxSprite()
                .WithKeywords(PlasmaKeyword.ID)
                .WithApplySFX(MainModFile.instance.ImagePath("SFX/PlasmaChannel.ogg"))
                .FreeModify(icon =>
                {
                    ...
                    GameObject vfx = new SpirefrostVFXBuilder(MainModFile.instance, "Icons/PlasmaIcon.png")
                    ...
                    if (loader != null)
                    {
                        SFXLoader.RegisterSoundToGlobal(EvokeID, loader.LoadSoundFromPath(MainModFile.instance.ImagePath("SFX/PlasmaEvoke.ogg")), 0.05f);
                    }
                });
        }
    }
