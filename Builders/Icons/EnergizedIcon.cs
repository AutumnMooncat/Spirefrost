...
{
    internal class EnergizedIcon : SpirefrostBuilder
    {
        internal static string ID => "STS Energized Icon";

        internal static string FullID => Extensions.PrefixGUID(ID, MainModFile.instance);

        internal static string SpriteID => "spirefrost.stsenergized";

        internal static object GetBuilder()
        {
            return new StatusIconBuilder(MainModFile.instance)
                .Create(ID, SpriteID, MainModFile.instance.ImagePath("Icons/EnergizedIcon.png"))
                ...
                .WithTextboxSprite()
                .WithKeywords(EnergizedKeyword.ID)
                ...
                .FreeModify(icon =>
                {
                    ...
                    GameObject vfx = new SpirefrostVFXBuilder(MainModFile.instance, "Icons/EnergizedIcon.png")
