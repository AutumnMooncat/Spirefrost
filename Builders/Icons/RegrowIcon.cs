...
{
    internal class RegrowIcon : SpirefrostBuilder
    {
        internal static string ID => "STS Regrow Icon";

        internal static string FullID => Extensions.PrefixGUID(ID, MainModFile.instance);

        internal static string SpriteID => "spirefrost.stsregrow";

        internal static object GetBuilder()
        {
            return new StatusIconBuilder(MainModFile.instance)
                .Create(ID, SpriteID, MainModFile.instance.ImagePath("Icons/RegrowIcon.png"))
                ...
                .WithTextboxSprite()
                .WithKeywords(RegrowKeyword.ID)
                .WithApplySFX(MainModFile.instance.ImagePath("SFX/Regrow.ogg"))
                .FreeModify(icon =>
                {
                    ...
                    GameObject vfx = new SpirefrostVFXBuilder(MainModFile.instance, "Icons/RegrowIcon.png")
