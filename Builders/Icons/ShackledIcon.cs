...
{
    internal class ShackledIcon : SpirefrostBuilder
    {
        internal static string ID => "STS Shackled Icon";

        internal static string FullID => Extensions.PrefixGUID(ID, MainModFile.instance);

        internal static string SpriteID => "spirefrost.stsshackled";

        internal static object GetBuilder()
        {
            return new StatusIconBuilder(MainModFile.instance)
                .Create(ID, SpriteID, MainModFile.instance.ImagePath("Icons/ShackleIcon.png"))
                ...
                .WithTextboxSprite()
                .WithKeywords(ShackledKeyword.ID)
                .WithApplySFX(MainModFile.instance.ImagePath("SFX/Shackled.ogg"))
                .FreeModify(icon =>
                {
                    ...
                    GameObject vfx = new SpirefrostVFXBuilder(MainModFile.instance, "Icons/ShackleIcon.png")
